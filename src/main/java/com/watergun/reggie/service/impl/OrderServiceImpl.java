...
import com.watergun.reggie.entity.*;
import com.watergun.reggie.mapper.OrderMapper;
import com.watergun.reggie.service.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Orders> implements OrderService {
    ...
    public void changeStatus(Map<String, String> map) {
        ...
        if (orderId == null || status == null) {
            throw new CustomException("传入信息非法");
        }

        Orders orders = this.getById(orderId);//根据订单id查询订单数据
